 ...
 * @author (Anthony Trad) 
 * @version (1.0)
 * NB: jai fais quelque copy paste quon peux eviter si on changer un peu
 * la structuration des classes qui nest pas demander
 */
       ...
       {        
           ...
           if(args!=null&&args.length>0)
            for(int i=0;i<args.length;i++)
            {
              ...
              System.out.println(valF + "\u00B0F -> " + valC + "\u00B0C");
            }              
       }
